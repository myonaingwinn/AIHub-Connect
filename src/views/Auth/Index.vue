<template>
  <div class="auth">
    <v-sheet class="d-flex flex-column align-center ma-8 pa-16 bg-white" elevation="2" rounded="lg" border>
      <div class="text-h2 mb-15">AIHub Connect</div>
      <div class="text-blue-grey">Your gateway to AI-powered connections</div>
